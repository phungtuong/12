...
<c:url var="urlCSS_Def" value="/resources/css/default.css" />
<c:set var="doc1">
	
</c:set>
<spring:url value="/resources/css/default.css" var="test"/>
<link href="${urlCSS_Def}" rel="stylesheet" type="text/css">
<c:url var="urlJS_Jquery"
	value="/resources/js/jquery-1.7.2.min.js.download" />
<c:set var="doc1">
	<script type="text/javascript" src="${urlJS_Jquery}"></script>
</c:set>
<spring:url value="${doc1}" />

<c:url var="urlJS_Common" value="/resources/js/Common.js.download" />
<c:set var="doc1">
	<script src="${urlJS_Common}" type="text/javascript"></script>
</c:set>
<spring:url value="${doc1}" />


<c:url var="urlJS_PagingContent"
	value="/resources/js/PagingContent.js.download" />
<c:set var="doc1">
	<script src="${urlJS_PagingContent}" type="text/javascript"></script>
</c:set>
<spring:url value="${doc1}" />

<c:url var="urlJS_logo"
	value="http://icsse2017.hcmute.edu.vn/Resources/Imagephoto/logo.png" />
<c:set var="doc1">
	<link rel="shortcut icon" type="image/png" href="${urlJS_logo }">
</c:set>
<spring:url value="${doc1}" />

<c:url var="urlJS_lightbox" value="/resources/css/lightbox.css" />
<c:set var="doc1">
	<link href="${urlJS_lightbox }" rel="stylesheet" type="text/css">
</c:set>
<spring:url value="${doc1}" />

<c:url var="urlJS_lightbox"
	value="resources/js/lightbox.min.js.download" />
<c:set var="doc1">
	<script src="${urlJS_lightbox }" type="text/javascript"></script>
</c:set>
<spring:url value="${doc1}" />


<c:url var="urlJS_search_Article"
	value="/resources/css/search_Article.css" />
<c:set var="doc1">
	<link href="${urlJS_search_Article }" rel="stylesheet">
</c:set>
<spring:url value="${doc1}" />

<c:url var="urlJS_nivo" value="/resources/css/nivo-slider.css" />
<c:set var="doc1">
	<link href="${urlJS_nivo }" rel="stylesheet">
</c:set>
<spring:url value="${doc1}" />
...
<c:url var="urlAXD_WebResource" value="/resources/axd/WebResource.axd" />
<c:set var="doc1">
	<link href="${urlAXD_WebResource }" type="text/css" rel="stylesheet"
		class="Telerik_stylesheet">
</c:set>
<spring:url value="${doc1}" />

<c:url var="urlAXD_WebResource1"
	value="/resources/axd/WebResource(1).axd" />
<c:set var="doc1">
	<link href="${urlAXD_WebResource1 }" type="text/css" rel="stylesheet"
		class="Telerik_stylesheet">
</c:set>
<spring:url value="${doc1}" />

<c:url var="urlAXD_WebResource2"
	value="/resources/axd/WebResource(2).axd" />
<c:set var="doc1">
	<link href="${urlAXD_WebResource2 }" type="text/css" rel="stylesheet"
		class="Telerik_stylesheet">
</c:set>
<spring:url value="${doc1}" />
	...
	<div id="pnTopDisplay" style="width: 1000px; float: left">
			...
			<div>
				<div class="P_top">
					<div class="P_logo">
						<div class="anh_logo">
							<img alt=""
								src="/resources/img/Banner_Hoi_nghi_quoc_te_sua.jpg"
		...
		<div id="ctl06_portlet_e28a24d5-befe-4213-a3d5-2e1ebcb2a71e"
			...
			<div>
				...
				<c:url var="urlJS_jquery_nivo"
					value="/resources/js/jquery.nivo.slider.js.download" />
				<c:set var="doc1">
					<script src="${urlJS_jquery_nivo }"></script>
				</c:set>
				<spring:url value="${doc1}" />
